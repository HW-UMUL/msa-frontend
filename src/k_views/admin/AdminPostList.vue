...
function issort() {
  ...
  sortedPosts.value.sort((a, b) => {
    ...
    switch (sortBy.value) {
      ...
      case 'table':
        return compareResult * (a.table.name.localeCompare(b.table.name))
      case 'like':
